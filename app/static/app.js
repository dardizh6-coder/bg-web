...
// When frontend and backend are on different domains (e.g. frontend on zhaku.eu, backend on Railway),
// set these BEFORE loading app.js:
...
async function boot() {
  ...
  try {
    ...
    alert("Could not reach backend.\n\n" + (e?.message || e) + "\n\nIf frontend and backend are on different domains, set window.API_BASE_URL and CORS_ORIGINS.");
  }
}
